...
folder are mapped to the application's root namespace, 'DocumentationViewer'. This is set in
`"app.json"`:

    "sass": {
        "namespace": "DocumentationViewer"
    }
...
included in the application's JavaScript code build. By default, files in this 
folder are mapped to the application's root namespace, 'DocumentationViewer' in the same way
as `"DocumentationViewer/sass/src"`.
